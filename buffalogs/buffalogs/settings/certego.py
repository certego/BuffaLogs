...
CERTEGO_BUFFALOGS_USER_LEARNING_PERIOD = 14
...
CERTEGO_BUFFALOGS_ES_MAX_RETRIES = int(os.environ.get("BUFFALOGS_ES_MAX_RETRIES", "10"))
CERTEGO_BUFFALOGS_ES_RETRY_MAX_TIME = int(os.environ.get("BUFFALOGS_ES_RETRY_MAX_TIME", "300"))
