...
if CERTEGO_BUFFALOGS_ENVIRONMENT == ENVIRONMENT_DOCKER:
    ...
    CERTEGO_BUFFALOGS_ELASTICSEARCH = os.environ.get("CERTEGO_BUFFALOGS_ELASTICSEARCH", "http://elasticsearch:59200/")
    ...
    CERTEGO_BUFFALOGS_ELASTICSEARCH = os.environ.get("CERTEGO_BUFFALOGS_ELASTICSEARCH", "http://localhost:59200/")
