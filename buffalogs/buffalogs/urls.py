...
urlpatterns = [
    ...
    path("users_pie_chart_api/<str:start>/<str:end>", views.users_pie_chart_api, name="users_pie_chart_api"),
    path("alerts_line_chart_api/<str:start>/<str:end>", views.alerts_line_chart_api, name="alerts_line_chart_api"),
    path("world_map_chart_api/<str:start>/<str:end>", views.world_map_chart_api, name="world_map_chart_api"),
]
