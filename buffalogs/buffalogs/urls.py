...
urlpatterns = [
    ...
    path(
        "api/users/<int:user_id>/logins/unique/",
        logins.get_user_unique_logins,
        name="user_unique_logins",
    ),
    # Analytics APIs
    path(
        "api/analytics/chart/users/pie/",
        charts.users_pie_chart_api,
        name="users_pie_chart_api",
    ),
    path(
        "api/analytics/chart/world-map/",
        charts.world_map_chart_api,
        name="world_map_chart_api",
    ),
    path(
        "api/analytics/chart/alerts/line/",
        charts.alerts_line_chart_api,
        name="alerts_line_chart_api",
    ),
    path(
        "api/users/<int:pk>/analytics/login-timeline/",
        charts.user_login_timeline_api,
        name="login_timeline_api",
    ),
    path(
        "api/users/<int:pk>/analytics/device-usage/",
        users.user_device_usage_api,
        name="device_usage_api",
    ),
    path(
        "api/users/<int:pk>/analytics/login-frequency/",
        users.user_login_frequency_api,
        name="login_frequency_api",
    ),
    path(
        "api/users/<int:pk>/analytics/time-of-day/",
        users.user_time_of_day_api,
        name="time_of_day_api",
    ),
    path(
        "api/users/<int:pk>/analytics/geo-distribution/",
    ...
    path(
        ...
        name="ingestion_sources_api",
    ),
    path(
        "api/ingestion/active_ingestion_source/",
        ingestion.get_active_ingestion_source,
        name="active_ingestion_source_api",
    ),
    path(
        "api/ingestion/<str:source>/",
        ingestion.ingestion_source_config,
        name="ingestion_source_config_api",
    ),
    # Alerters APIs
    path(
        "api/alerters/active-alerter/",
