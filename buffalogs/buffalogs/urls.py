...
urlpatterns = [
    ...
    path("users/<int:pk_user>/all_logins", users.all_logins_page, name="all_logins_page"),
    path("users/<int:pk_user>/unique_logins", users.unique_logins_page, name="unique_logins_page"),
