...
class DetectionTestCase(TestCase):
    ...
    def test_check_country_atypical_country_alert(self):
        ...
        self.assertEqual(
            AlertDetectionType.ATYPICAL_COUNTRY.value,
            alert_result["alert_name"],
        )
        self.assertEqual(
    ...
    def test_check_new_device_alert(self):
        ...
        alert_result = detection.check_new_device(
            db_user, last_login_user_fields
        )
    ...
    def test_update_risk_level_norisk(self):
        ...
        # 0 alert --> no risk
        self.assertTrue(
            User.objects.filter(username="Lorena Goldoni").exists()
        )
        db_user = User.objects.get(username="Lorena Goldoni")
    ...
    def test_update_risk_level_low(self):
        ...
        self.assertEqual(
            AlertDetectionType.IMP_TRAVEL.value, alerts_user[0].name
        )
        # then, the second alert must be the USER_RISK_THRESHOLD
        self.assertEqual(
            AlertDetectionType.USER_RISK_THRESHOLD, alerts_user[1].name
        )
        self.assertEqual(
    ...
    def test_update_risk_level_medium(self):
        ...
        self.assertEqual("Low", db_user.risk_score)
        db_config.risk_score_increment_alerts = [
        ...
        self.assertEqual(AlertDetectionType.NEW_DEVICE, alerts_user[2].name)
        self.assertEqual(
            AlertDetectionType.ATYPICAL_COUNTRY, alerts_user[3].name
        )
        self.assertEqual(
            AlertDetectionType.USER_RISK_THRESHOLD, alerts_user[4].name
        )
        ...
        self.assertEqual(
            AlertDetectionType.ATYPICAL_COUNTRY, alerts_user[5].name
        )
        self.assertEqual(
            AlertDetectionType.ATYPICAL_COUNTRY, alerts_user[6].name
        )
        self.assertEqual(
            AlertDetectionType.ATYPICAL_COUNTRY, alerts_user[7].name
        )
        self.assertEqual(
            AlertDetectionType.USER_RISK_THRESHOLD, alerts_user[8].name
        )
        self.assertEqual(
    ...
    def test_update_risk_level_high(self):
        ...
        self.assertEqual(
            AlertDetectionType.USER_RISK_THRESHOLD, alerts_user[10].name
        )
        self.assertEqual(
    ...
    def test_check_fields_logins(self):
        ...
        self.assertEqual(
            50,
            Login.objects.get(user=db_user, country="India").timestamp.minute,
        )
        self.assertEqual(
            3,
            Login.objects.get(user=db_user, country="India").timestamp.second,
        )
        self.assertEqual(
            1,
            Login.objects.filter(
        ...
        self.assertEqual(
            7,
            Login.objects.get(
                user=db_user, country="United States"
            ).timestamp.hour,
        )
        self.assertEqual(
            10,
        ...
        self.assertEqual(
            57,
            Login.objects.get(user=db_user, country="Japan").timestamp.minute,
        )
        self.assertEqual(
            27,
            Login.objects.get(user=db_user, country="Japan").timestamp.second,
        )
    ...
    def test_check_fields_alerts(self):
        ...
        self.assertEqual(
            "Anonymous IP Login", anonymous_ip_alerts_fields1[0].name
        )
        self.assertEqual(
        ...
        self.assertEqual(
            ...
            Alert.objects.filter(
                user=db_user, filter_type=["is_vip_filter"]
            ).count(),
        )
