...
class TestAlertAPI(APITestCase):
    ...
    def test_get_alert_types(self):
        expected = [
            ...
            {
                "alert_type": "Imp Travel",
                "description": "Impossible Travel detected",
            },
            {
                "alert_type": "New Country",
    ...
    @mock.patch(
        "impossible_travel.views.alerts.read_config",
    ...
    @mock.patch(
        "impossible_travel.views.alerts.write_config",
        side_effect=mock_write_config,
    )
