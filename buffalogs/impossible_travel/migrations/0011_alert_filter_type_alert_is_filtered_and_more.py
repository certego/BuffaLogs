# Generated by Django 5.0.3 on 2024-11-18 16:31
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ("impossible_travel", "0010_config_alert_max_days_config_distance_accepted_and_more"),
    ]
    ...
    operations = [
        ...
        migrations.AddField(
            model_name="alert",
            name="is_filtered",
            field=models.BooleanField(default=False, help_text="Show if the alert has been filtered because of some filter (listed in the filter_type field)"),
        ),
        migrations.AddField(
            model_name="config",
            name="alert_is_vip_only",
            field=models.BooleanField(default=False, help_text="Flag to send alert only related to the users in the vip_users list"),
        ),
        migrations.AddField(
            model_name="config",
            name="alert_minimum_risk_score",
            field=models.CharField(
                choices=[("NO_RISK", "No risk"), ("LOW", "Low"), ("MEDIUM", "Medium"), ("HIGH", "High")],
                default="No risk",
        ...
        migrations.AddField(
            ...
            field=models.BooleanField(default=False, help_text="Flag to ignore mobile devices from the detection"),
        ),
        ...
        migrations.AlterField(
            model_name="user",
            name="risk_score",
            field=models.CharField(choices=[("NO_RISK", "No risk"), ("LOW", "Low"), ("MEDIUM", "Medium"), ("HIGH", "High")], default="No risk", max_length=30),
        ),
    ]
